...
if (conf.LANG == 'TR') {
    ...
    already_on = 'ALVINser yapay zekası halihazırda tüm fonksiyonları etkin.'
    already_off = 'ALVINser yapay zekası halihazırda yarı fonksiyonel çalışıyor.'
    succ_on = 'ALVINser, Tam Fonksiyonel Olarak Açıldı! Lütfen Biraz Bekleyin! ✅'
    succ_off = 'ALVINser, Yarı Fonksiyonel Olarak Ayarlandı! Lütfen Biraz Bekleyin! ☑️'
}
if (conf.LANG == 'EN') {
    fulleva_dsc = 'Activates full functional Pikachu features. Turn your account into a ai chatbot!'
    already_on = 'ALVINser artificial intelligence is already fully functional.'
    already_off = 'ALVINser artificial intelligence is currently running semi-functional.'
    succ_on = 'ALVINser Opened Fully Functionally! Please wait a bit! ✅'
    succ_off = 'ALVINser Set to Semi-Functional! Please wait a bit! ☑️'
}
if (conf.LANG == 'ML') {
